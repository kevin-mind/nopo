/**
 * Discussion Action Emitters
 *
 * Functions that emit actions for the discussion state machine.
 * Each emitter returns an array of actions to be executed.
 */
 ...
 * Uses the discussion/research prompt from @more/prompts.
 */
 ...
 *
 * Uses the discussion/respond prompt from @more/prompts.
 */
 ...
 *
 * Uses the discussion/summarize prompt from @more/prompts.
 */
 ...
 *
 * Uses the discussion/plan prompt from @more/prompts.
 */
