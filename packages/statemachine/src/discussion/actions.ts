/**
 * Discussion Action Schemas
 *
 * Defines all action types for the discussion automation state machine.
 * Actions are emitted by the machine and executed by the runner.
 */
