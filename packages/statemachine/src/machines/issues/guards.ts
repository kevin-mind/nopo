...
import { isTerminalStatus } from "../../core/schemas.js";
import { extractTodosFromAst } from "../../core/parser.js";
 ...
 */
export function triggeredByDeployedStageFailure({
  context,
}: GuardContext): boolean {
 ...
 */
export function triggeredByDeployedProdFailure({
  context,
}: GuardContext): boolean {
