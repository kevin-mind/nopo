...
import { z } from "zod";
import { CIResultSchema, IssueTriggerTypeSchema } from "../../schemas/index.js";
 ...
 * Overall test result
 */
export const ConfigurableTestResultSchema = z.object({
  /** Overall status */
...
export type ConfigurableTestResult = z.infer<
  typeof ConfigurableTestResultSchema
>;
